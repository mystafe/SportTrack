      ...
      {isExpanded && (
        <div className="space-y-3 pt-2 border-t border-blue-200 dark:border-blue-800 animate-fade-in">
          <div className="space-y-2">
            <h4 className={`${isMobile ? 'text-xs' : 'text-sm'} font-semibold text-gray-900 dark:text-white`}>
              {t('appleHealth.step1')}
            </h4>
            <ol className={`${isMobile ? 'text-xs' : 'text-sm'} text-gray-700 dark:text-gray-300 space-y-2 list-decimal list-inside ml-2`}>
          ...
          <div className="rounded-lg bg-blue-100 dark:bg-blue-900/30 p-3 border border-blue-200 dark:border-blue-800">
            <p className={`${isMobile ? 'text-xs' : 'text-sm'} text-blue-900 dark:text-blue-200 font-medium`}>
