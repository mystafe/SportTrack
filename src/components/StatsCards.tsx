    ...
    <div className="spacing-lg">
      ...
      <div className="card-entrance rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900/95 dark:via-gray-800/95 dark:to-gray-900/95 p-4 shadow-md hover:shadow-xl transition-shadow duration-300">
        ...
        {overviewOpen && (
          <div
            id="stats-overview"
            className={`grid ${isMobile ? 'grid-cols-2' : 'grid-cols-1 sm:grid-cols-3'} ${isMobile ? 'gap-2.5' : 'gap-4'}`}
          >
            <div
            ...
            >
              ...
              <div
                className={`${isMobile ? 'h-2.5' : 'h-2'} bg-gray-200 dark:bg-gray-800 rounded overflow-hidden relative`}
                role="progressbar"
                aria-valuenow={pct}
                aria-valuemin={0}
                aria-valuemax={100}
