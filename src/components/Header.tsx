...
export function Header() {
  ...
  return (
    <header className="border-b border-gray-200 dark:border-gray-800 bg-white/60 dark:bg-gray-950/60 backdrop-blur sticky top-0 z-40">
      <nav className="container flex items-center justify-between h-12 sm:h-12" role="navigation" aria-label={t('nav.main')}>
        <Link href="/" className="font-semibold text-lg sm:text-lg" aria-label={t('nav.home')}>
          SportTrack
        </Link>
