      ...
      var en = (function e() {
        ...
        let {
            ...
            if (!tt || tt !== e) {
              if (
                ...
                (te =
                  ...
                  (e6 = -1 === e7.indexOf(e.PARSER_MEDIA_TYPE) ? 'text/html' : e.PARSER_MEDIA_TYPE)
                    ? E
                    : y),
                (e_ = S(e, 'ALLOWED_TAGS') ? v({}, e.ALLOWED_TAGS, te) : eb),
                (eN = S(e, 'ALLOWED_ATTR') ? v({}, e.ALLOWED_ATTR, te) : eS),
                (e3 = S(e, 'ALLOWED_NAMESPACES') ? v({}, e.ALLOWED_NAMESPACES, E) : e8),
                (eV = S(e, 'ADD_URI_SAFE_ATTR') ? v(R(eZ), e.ADD_URI_SAFE_ATTR, te) : eZ),
                (e$ = S(e, 'ADD_DATA_URI_TAGS') ? v(R(eK), e.ADD_DATA_URI_TAGS, te) : eK),
                (eq = S(e, 'FORBID_CONTENTS') ? v({}, e.FORBID_CONTENTS, te) : eX),
                ...
                ej &&
                  ((e_ = v({}, z)),
                  (eN = []),
                  !0 === ej.html && (v(e_, x), v(eN, P)),
                  !0 === ej.svg && (v(e_, L), v(eN, H), v(eN, G)),
                  !0 === ej.svgFilters && (v(e_, O), v(eN, H), v(eN, G)),
                  !0 === ej.mathMl && (v(e_, M), v(eN, F), v(eN, G))),
                e.ADD_TAGS &&
                  ('function' == typeof e.ADD_TAGS
                    ? (ev.tagCheck = e.ADD_TAGS)
                    : (e_ === eb && (e_ = R(e_)), v(e_, e.ADD_TAGS, te))),
                e.ADD_ATTR &&
                ...
                e.FORBID_CONTENTS && (eq === eX && (eq = R(eq)), v(eq, e.FORBID_CONTENTS, te)),
                eB && (e_['#text'] = !0),
                eM && v(e_, ['html', 'head', 'body']),
                e_.table && (v(e_, ['tbody']), delete eC.tbody),
                ...
                : e.namespaceURI === eJ
                  ? t.namespaceURI === e0
                    ...
                    : t.namespaceURI === eQ
                      ...
                      : !!ta[n]
                  : e.namespaceURI === e0
                    ? (t.namespaceURI !== eQ || !!e4[o]) &&
                      (t.namespaceURI !== eJ || !!e9[o]) &&
                      !ta[n] &&
                      (e5[n] || !ti[n])
                    : 'application/xhtml+xml' === e6 && !!e3[e.namespaceURI])
            );
          },
          tc = function (e) {
          ...
          tu = function (e) {
            ...
            return (e && o && a.insertBefore(i.createTextNode(o), a.childNodes[0] || null),
            e1 === e0)
        ...
        let th = function (e) {
            let t = null;
            if ((td(em.beforeSanitizeElements, e, null), tp(e))) return (tc(e), !0);
            let n = te(e.nodeName);
            if (
              (td(em.uponSanitizeElement, e, { tagName: n, allowedTags: e_ }),
              (eI &&
                e.hasChildNodes() &&
              ...
              return (tc(e), !0);
            if (!(ev.tagCheck instanceof Function && ev.tagCheck(n)) && (!e_[n] || eC[n])) {
              if (
                !eC[n] &&
                tT(n) &&
            ...
            return (e instanceof k && !tl(e)) ||
              ...
              : (eO &&
                  ...
                  e.textContent !== t &&
                    (g(r.removed, { element: e.cloneNode() }), (e.textContent = t))),
                td(em.afterSanitizeElements, e, null),
                !1);
          },
          tg = function (e, t, n) {
            if (eG && ('id' === t || 'name' === t) && (n in i || n in tn)) return !1;
            if (eD && !ek[t] && w(eh, t));
            else if (eR && w(eg, t));
            else if (ev.attributeCheck instanceof Function && ev.attributeCheck(t, e));
            else if (!eN[t] || ek[t]) {
              if (
                !(
                  (tT(e) &&
            ...
            else if (ex && !w(eT, _(n, ey, '')));
            else if (n) return !1;
            return !0;
          },
          tT = function (e) {
            return 'annotation-xml' !== e && A(e, eE);
          },
          ty = function (e) {
            ...
            for (; i--; ) {
              ...
              if (
                ...
                (u = o.attrValue),
                eW && ('id' === s || 'name' === s) && (ts(a, e), (u = 'user-content-' + u)),
        ...
        return (
          (r.sanitize = function (e) {
            let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
              ...
              l = null,
              c = null;
            if (((e2 = !e) && (e = '<!-->'), 'string' != typeof e && !tf(e))) {
            ...
            if ((eU || tr(n), (r.removed = []), 'string' == typeof e && (eY = !1), eY)) {
              if (e.nodeName) {
                let t = te(e.nodeName);
                if (!e_[t] || eC[t])
              ...
              (i = (o = tu('<!---->')).ownerDocument.importNode(e, !0)).nodeType === Q.element &&
              'BODY' === i.nodeName
                ? (o = i)
                : 'HTML' === i.nodeName
                  ? (o = i)
              ...
              if (!eP && !eO && !eM && -1 === e.indexOf('<')) return t && eF ? t.createHTML(e) : e;
              if (!(o = tu(e))) return eP ? null : eF ? ei : '';
            }
            o && ez && tc(o.firstChild);
            let u = tm(eY ? e : o);
            for (; (l = u.nextNode()); ) (th(l), ty(l), l.content instanceof s && tE(l.content));
            if (eY) return e;
            if (eP) {
              if (eH)
                for (c = ec.call(o.ownerDocument); o.firstChild; ) c.appendChild(o.firstChild);
              else c = o;
