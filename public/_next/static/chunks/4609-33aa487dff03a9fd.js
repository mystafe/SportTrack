            ...
            72: function (t, r, e) {
              ...
              ((r.Buffer = u),
                ...
                (u.compare = function (t, r) {
                  if (
                    (C(t, Uint8Array) && (t = u.from(t, t.offset, t.byteLength)),
                ...
                (u.concat = function (t, r) {
                  ...
                  for (e = 0; e < t.length; ++e) {
                    var i = t[e];
                    if ((C(i, Uint8Array) && (i = u.from(i)), !u.isBuffer(i)))
                      throw TypeError('"list" argument must be an Array of Buffers');
                ...
                (u.prototype.compare = function (t, r, e, n, o) {
                  if ((C(t, Uint8Array) && (t = u.from(t, t.offset, t.byteLength)), !u.isBuffer(t)))
                    throw TypeError(
                ...
                (u.prototype.write = function (t, r, e, n) {
                  ...
                  for (var v = !1; ; )
                    switch (n) {
                      ...
                      case 'utf8':
                      case 'utf-8':
                        return ((s = r), (a = e), x(U(t, this.length - s), this, s, a));
                      case 'ascii':
                        return ((h = r), (c = e), x(I(t), this, h, c));
                      case 'latin1':
                      case 'binary':
                        return ((o = this), (i = t), (f = r), (u = e), x(I(i), o, f, u));
                      case 'base64':
                        return ((p = r), (l = e), x(L(t), this, p, l));
                      case 'ucs2':
                      case 'ucs-2':
                      case 'utf16le':
                      case 'utf-16le':
        ...
        var r = {
            229: function (t) {
              ...
              var s = [],
                ...
                h = -1;
              function c() {
                a && n && ((a = !1), n.length ? (s = n.concat(s)) : (h = -1), s.length && p());
              }
              function p() {
                if (!a) {
                  var t = u(c);
